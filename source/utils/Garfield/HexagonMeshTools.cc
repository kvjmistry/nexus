...
namespace HexagonMeshTools {
  ...
  G4ExtrudedSolid* HexagonMeshTools::CreateHexagon(G4double Thickness, G4double circumradius){
    ...
    return new G4ExtrudedSolid("Extruded", polygon, Thickness/2.0, offsetA, scaleA, offsetB, scaleB);
  ...
  void HexagonMeshTools::PlaceHexagons(G4int nHole, G4double InRadius, G4double Thickness, G4LogicalVolume* DiskLogical, G4LogicalVolume* HexLogical){
